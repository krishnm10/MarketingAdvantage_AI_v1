...
def _ensure_default_chunkers() -> None:
    ...
    from app.services.ingestion import segmenter_overlap  # noqa: F401
    from app.services.ingestion import segmenter_recursive_overlap  # noqa: F401
    from app.services.ingestion import segmenter_rust  # noqa: F401
    from app.services.ingestion import segmenter_smart  # noqa: F401
